...
export default function BetShopsForm ({t, method, infoText, transactionType, submitting, paymentMethodInfoByCurrency, limits, getFormItem, error, cities, currencyCode}) {
    return (
